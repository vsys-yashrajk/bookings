...
import (
	...
	"github.com/Yashrajkanade/bookings/internal/forms"
	...
	"github.com/Yashrajkanade/bookings/internal/repository"
	"github.com/Yashrajkanade/bookings/internal/repository/dbrepo"
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	rooms, err := m.DB.SearchAvaliabilityForAllRooms(startDate, endDate)
	if err != nil {
		helpers.ServerError(w, err)
	}
	if len(rooms) == 0 {
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	avaliable, err := m.DB.SearchAvaliabilityByDatesByRoomID(startDate, endDate, roomID)
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
